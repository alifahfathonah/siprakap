...
<head>
    ...
    <title>Login Sistem Pengajuan Surat Kerja Praktek</title>
...
<body class="off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" data-image="<?= base_url() ?>assets/img/register.jpeg">
                            ...
                            <form method="post" action="">
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="orange">
                                        ...
                                        <h5 class="card-title">Sistem Pengajuan Surat Kerja Praktek PENS PSDKU Lamongan</h5>
                                    ...
                                    <!-- <img src="<?= base_url() ?>assets/img/logo_pens.png"> -->
