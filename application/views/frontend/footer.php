                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">Pedoman Kerja Praktek</h2>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Contoh Proposal Kerja Praktek</h2>
                                    <p class="item-intro text-muted">|</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">List Perusahaan Kerja Praktek</h2>
                                    <p class="item-intro text-muted">|</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Contoh Aja Si</h2>
                                    <p class="item-intro text-muted">|</p>
